                    ...
                    <div class="col-lg-6">
                        <form role="form" name="frmCSVImport" id="frmCSVImport" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Certificate Line-1" name="l_1" type="text">
                            </div>
                            <div class="form-group">
                                <label for="l_2">Certificate Line-2</label>
                                <input class="form-control" placeholder="Certificate Line-2" name="l_2" type="text">
                            </div>
                            <div class="form-group">
                                <label for="l_3">Certificate Line-3</label>
                                <input class="form-control" placeholder="Certificate Line-3" name="l_3" type="text">
                            </div>
                            <!--<div class="form-group">-->
