			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<br>
						<?php
						if(isset($_POST['ok']) || isset($_SESSION['dept'])) {
							...
							$dept=$_SESSION['dept'];
							$seminar_date=$_SESSION['seminar_date'];
							$col_id=$_SESSION['col_id'];
							unset($_SESSION['dept']);
							unset($_SESSION['seminar_date']);
									...
									<table class="table table-bordered table-striped">
										...
										?>
											<tr>
												...
												<td>
													<form name="upd-student-<?php echo $i; ?>" method="post" action="update_student.php">
                                                    	<input type="hidden" name="id" value="<?php echo $std_rec['std_id'] ?>">
														<input type="hidden" name="col_id" value="<?php echo $std_rec['col_id'] ?>">
														<input type="hidden" name="seminar_date" value="<?php echo $std_rec['seminar_date'] ?>">
														<input type="hidden" name="dept" value="<?php echo $std_rec['dept'] ?>">
												...
												<td>
													...
													?>
													<form name="frm" method="post" action="c_pdf.php">
														<input type="hidden" name="std_id" value="<?php echo $std_rec['std_id']; ?>">
														<input type="submit" name="ok" value="Already Generate" class="btn btn-warning">
													</form>
													...
													<form name="frm" method="post" action="c_pdf.php">
														<input type="hidden" name="std_id" value="<?php echo $std_rec['std_id']; ?>">
														<input type="submit" name="ok" value="Generate" class="btn btn-success">
													</form>
													<?php
													}
													?>
