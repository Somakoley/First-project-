                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" name="del" value="Recall Student" class="btn btn-danger">
                            <!-- <a href="delete_student.php"  class="" value="Delete Student">Delete Student</a> -->
                        </form>
                        
                        <?php
                        if(isset($_POST['del'])){
                            $del=mysqli_query($conn,"UPDATE certificate_table SET std_status='1' WHERE std_id=".$std_id) or die(mysqli_error($conn));
