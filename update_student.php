            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php
                        if(isset($_POST['del'])){
                            $del=mysqli_query($conn,"UPDATE student SET active='0' WHERE std_id=".$std_id) or die(mysqli_error($conn));
                        ...
                        if (isset($_POST['ok'])) {
                            ...
                            $l_3=$_POST['l_3'];
                            $seminar_date=$_POST['seminar_date'];
                            $upd = mysqli_query($conn, "UPDATE student SET c_type='".mysqli_real_escape_string($conn,$c_type)."',awd_to='".mysqli_real_escape_string($conn,$awd_to)."',std_name='".mysqli_real_escape_string($conn,$std_name)."',email='".mysqli_real_escape_string($conn,$email)."',mobile='".mysqli_real_escape_string($conn,$mobile)."',subject='".mysqli_real_escape_string($conn,$subject)."',dept='".mysqli_real_escape_string($conn,$dept)."',col_id='$col_id',l_1='".mysqli_real_escape_string($conn,$l_1)."',l_2='".mysqli_real_escape_string($conn,$l_2)."',l_3='".mysqli_real_escape_string($conn,$l_3)."',seminar_date='$seminar_date' WHERE std_id=".$std_id) or die(mysqli_error($conn));
                            if ($upd == 1) {
