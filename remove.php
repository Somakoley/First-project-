                    ...
                    <div class="col-6">
                        ...
                        if(isset($_POST['ok']) || isset($_SESSION['subject'])) {
                            ...
                            if (!empty($col_id) && !empty($issue_date)) {
                                $sql = "SELECT s.*,c.col_name FROM certificate_table s INNER JOIN college c ON s.col_id=c.col_id WHERE s.col_id=$col_id AND s.issue_date='$issue_date' AND s.subject='$subject' AND s.std_status='0'";
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $sl; ?></td>
                                                <td>
													<form name="upd-student-<?php echo $i; ?>" method="post" action="recall.php">
