	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">All Remove Students</h1>
					...
					<div class="col-lg-12">
						...
						if (isset($_POST['ok'])) {
							...
							if (!empty($col_id) && !empty($seminar_date)) {
								$sql = "SELECT s.*,c.col_name FROM student s INNER JOIN college c ON s.col_id=c.col_id WHERE s.col_id=$col_id AND s.seminar_date='$seminar_date' AND s.dept='$dept' AND s.active='0'";
									...
									<table class="table table-bordered table-striped">
										...
										?>
											<tr>
												...
												<td>
													<form name="upd-student-<?php echo $i; ?>" method="post" action="recall_student.php">
